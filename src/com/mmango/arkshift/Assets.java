...
public class Assets {
	...
	knock_8b_22050Hz.ogg
	shift_8b_22050.ogg*/
	
	public static void loat(GLGame game){
		mainScreenBackground = new Texture(game, "background_mainscreen_1080x1920.png");
		...
		mainScreenMenuRegion = new TextureRegion(mainScreenMenu, 0, 0, 700, 1000);
		
		gameScreenBackground = new Texture(game, "atlas_background.png");
		gameScreenBackgroundRegion = new TextureRegion(gameScreenBackground, 0, 0, 1080, 1920);
		...
		/*
				...
				You only need to provide an active credit link to our website from yours stating: 
				Royalty free production music by JewelBeat
				
				or use the following html code:
				<a href="http://www.jewelbeat.com/">Royalty free production music by JewelBeat</a>
		 */
